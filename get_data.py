file_path = "/config/workspace/sensor-fault-detection/aps_failure_training_set1.csv"
...
if __name__=="__main__":
    data_file_path = "/config/workspace/sensor-fault-detection/aps_failure_training_set1.csv"
